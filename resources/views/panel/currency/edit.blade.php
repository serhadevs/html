    ...
    <div class="content-wrapper">
        ...
        <!-- Main content -->
            ...
            @endif  
                ...
                <form class="form-horizontal" method="Post" autocomplete="off" action="/currency/{{$currency->id}}" >
                  @csrf
                  @method('patch');
                        ...
                        <div class="col-sm-4">
                        <input type="text" id="abbr" name ="abbr" class="form-control" value="{{$currency->abbr}}" required>
                          </div>
                      ...
                      {{-- <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input type="text" id="description" name ="description" required class="form-control" value="{{$currency->description}}">
