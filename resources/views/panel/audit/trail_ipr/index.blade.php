    ...
    <div class="content-wrapper">
        ...
        <!-- Main content -->
              ...
              <div class="col-sm-10">
                        ...
                        <h3 class="card-title">Trail Internal Requisition</h3>
                        </div>
                        </div>
                        </div>
            ...
            @endif  
                ...
                <form class="form-horizontal" method="Post" autocomplete="off" action="/trail-ipr" >
                  @csrf
                        ...
                        <label for="name" class="col-sm-2 col-form-label">Audible Type</label>
                        <div class="col-sm-4">
