               ...
               <div class="title">
                        ...
                        The Towers, 25 Dominica Drive, Kingston 5</p>
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                <input type="input" class="form-control" id='voucher_no' name="voucher_no" value="">
                                <input type="hidden" class="form-control" id='purchase_order_id' name="purchase_order_id" value="{{$purchaseOrder->id}}">
                              </div>
                                ...
                                <div class="col-sm-4">
                                  <div class="input-group date" id="voucher_date" data-target-input="nearest">
                                    <input type="text" class="form-control datepicker-input" name='voucher_date' data-target="#voucher_date"/>
                                ...
                                <div class="col-sm-4">
                                <input type="input" class="form-control" value="" id="cheque_no" name="cheque_no">
                                ...
                                <div class="col-sm-4">
                                  <div class="input-group date" id="cheque_date" data-target-input="nearest">
                                    <input type="text" class="form-control datepicker-input" name='cheque_date' data-target="#cheque_date"/>
                              ...
                              <div class="form-group row">
                                ...
                                <input type="input" class="form-control"  value="{{$purchaseOrder->requisition->commitment_no}}"name='commitment' id="commitment" readonly>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="input" class="form-control" value="{{$purchaseOrder->requisition->institution->name}}" name='cost_centre' disabled>
                                    </div>
                                ...
                                <div class="col-sm-4">
                                <input type="input" class="form-control" value="{{$purchaseOrder->requisition->requisition_no}}" name='requisition_no' disabled>
                                </div>
                                <label for="date-of-last" class="col-sm-2 col-form-label">P.O.</label>
                                <div class="col-sm-4">
                                 
                                 <input type="input" class="form-control" value="{{$purchaseOrder->purchase_order_no}}" name='purchase_order_no' disabled>
                                  ...
                                  <table id="stock-table" class="table table-bordered table-responsive-md table-striped text-center">
                                    ...
                                    <tbody>
                                      ...
                                      <tr>
                                        ...
                                        <input name='invoice_num[]' class='invoice_num' id="invoice_num" type='text' size="5" style='border:none;outline:none;background: transparent;'>
                                       
                                        </td>
                                        <td>
                                        
                                       
                                           <input name='parish_code[]' class='parish_code' type='text' size="10" style='border:none;outline:none;background: transparent;'>
                                        </td>
                                        <td>
                                            <input name='institution_code[]'  type='text' size="10" style='border:none;outline:none;background: transparent;'>
                                        </td>
                                        
                                        <td>
                                            <input name='value[]' class='value' id="value" type='text' size="5" style='border:none;outline:none;background: transparent;'>
                                        </td> 
                                        <td>
                                          <input name='account_num[]'size="5" class='account_num' type='number'style='width:80px; border:none;outline:none;background: transparent;'>
                                        </td>
                                        <td>
                                          <input name='amount[]' class='amount' id="amount" type='text' size="5" style='border:none;outline:none;background: transparent;'>
                                        </td>
                                  ...
                                  <div class="row">
                                    <div class="col-sm-6">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="amount_in_words" rows="3" placeholder="Enter ..."></textarea>
                                      </div>
                                    </div>
