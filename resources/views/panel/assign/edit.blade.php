...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Edit Assign Internal Requisition</h1>
          </div>
          <div class="col-sm-6">
  ...
  <tr >
   ...
   <tr>
    ...
    @else
    <td><input  readonly  name="sales_tax" id="sales_tax" type='text' size="10" value="${{number_format($internalRequisition->stocks->sum('estimated_total') * .15) }}" style='border:none;outline:none;background: transparent;'></td>
    @endif
    </tr>
   <tr>
...
{{$comment->user->abbrName()}}: {{$comment->comment}}
 ...
 <div class="form-group row">
          ...
          <br>
                        ...
                        <form class="form-horizontal"  method="Post" autocomplete="off" action="/assign_requisition/{{$internalRequisition->id}}/update" enctype="multipart/form-data">
                         @csrf
                         @method('PATCH') 
                        ...
                        <div class="col-sm-5">
                         ...
                         <select type="input" class="form-control" name="user_id" id="user_id" required>
                          <option value="{{$internalRequisition->assignto->user->id}}">{{$internalRequisition->assignto->user->abbrName()}}</option>
            ...
            <!-- /.card -->
                        ...
                        <button type="submit"   class="btn btn-block btn-outline-primary  btn-lg" >Update</button></br>
