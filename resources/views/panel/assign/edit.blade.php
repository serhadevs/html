...
<div class="content-wrapper">
 ...
 <div class="form-group row">
          ...
          <br>
                        ...
                        Approve Internal Request by: <span class='badge badge-success'>{{$internalRequisition->approve_internal_requisition->user->firstname[0]}}. {{$internalRequisition->approve_internal_requisition->user->lastname}} </span>
                        Date:  <span class='badge badge-success'>{{$internalRequisition->approve_internal_requisition->created_at}}</span>
                        @else
                          Approve Purchase Order by: <span class='badge badge-success'></span>
                          @endif
                        </div>
                        <div class="col-sm-5">
