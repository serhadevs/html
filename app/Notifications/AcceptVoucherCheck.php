...
class AcceptVoucherCheck extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        ->line('The payment voucher was checked and ready for certifying,the payment voucher number is '.$this->payment_voucher->voucher_no.'.')
